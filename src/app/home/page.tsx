...
export default function Home(): React.JSX.Element {
  return (
    <main className="min-h-screen flex flex-col">
      ...
      >
        <h2 className="text-5xl lg:text-6xl no-italic py-8">My expertise</h2>
        <div className="w-full flex flex-col justify-evenly items-center py-6 text-2xl sm:text-3xl lg:text-4xl md:flex-row md:items-start">
          <Expertise entry="1" />
          <Expertise entry="2" />
          <Expertise entry="3" />
        </div>
      ...
      <section
        className="flex flex-col flex-grow items-center bg-bg-3"
        aria-label="Industries and companies Cristina Jiménez has workded for"
      >
        <h2 className="text-5xl lg:text-6xl no-italic py-8">Industries</h2>
        <div className="w-full flex flex-col justify-evenly items-center gap-12 py-6 text-2xl sm:text-3xl lg:text-4xl md:flex-row md:items-start">
          {/* <Industry /> */}
        </div>
      </section>
      <section
      ...
      >
        <h2 className="text-4xl lg:text-5xl no-italic p-8">Let's work together</h2>
